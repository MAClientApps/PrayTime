...
import com.code.apppraytime.times.internal.SolarTime
import com.code.apppraytime.times.data.TimeComponents
import java.util.*
    ...
    init {
        ...
        if (!error) {
            ...
            if (calculationParameters.ishaInterval > 0) {
                ...
                val safeIsha: Date = if (calculationParameters.method == CalculationMethod.MOON_SIGHTING_COMMITTEE) {
        ...
        if (error || tempAsr == null) {
            // if we don't have all Pray Times then initialization failed
            fajr = null
            sunrise = null
            dhuhr = null
            asr = null
