package com.code.apppraytime.views.sun;

import static com.code.apppraytime.constant.App.SUN_ANIM_DURATION;
import static com.code.apppraytime.constant.App.TRACK_RADIUS;
...
import com.code.apppraytime.views.sun.formatter.SimpleSunriseSunsetLabelFormatter;
import com.code.apppraytime.views.sun.formatter.SunriseSunsetLabelFormatter;
...
public class SunriseSunsetView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mTrackRadius = TRACK_RADIUS * (widthSpecSize - paddingLeft - paddingRight - 2 * mSunRadius) / 2;
    ...
    public void startAnimate() {
        ...
        animator.setDuration(SUN_ANIM_DURATION);
        animator.setInterpolator(new LinearInterpolator());
        animator.start();
    }

    public void startWithoutAnimate() {
        if (mSunriseTime == null || mSunsetTime == null) {
            throw new RuntimeException("You need to set both sunrise and sunset time before start animation");
        }
        int sunrise = mSunriseTime.transformToMinutes();
